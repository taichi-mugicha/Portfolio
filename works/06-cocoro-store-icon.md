...
| 項目 | 内容 |
|---|---|
| ヒーローイメージ | ![](./images/cocoro-store-icon/01.png) |
...
![](./images/cocoro-store-icon/02.png)
*アプリの主要画面をまとめた全体像（仮）*
...
![](./images/cocoro-store-icon/03.png)
...
![](./images/cocoro-store-icon/04.png)
